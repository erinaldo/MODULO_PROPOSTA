angular.module('App').controller('PortalAppController', ['$scope', '$rootScope', 'tokenApi', 'httpService', '$location', function ($scope, $rootScope, tokenApi, httpService, $location) {
    ...
    httpService.Get('credential/GetUserModulos').then(function (response) {
        if (response) {
            $scope.AppModulos = response.data;
        }
    });
    ...
    //   },
    //];
    httpService.Get('credential/GetUserMenu').then(function (response) {
        if (response) {
            $scope.ShortMenus = response.data;
        }
    });
