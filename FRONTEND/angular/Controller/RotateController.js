angular.module('App').controller('RotateController', ['$scope', '$rootScope', '$location', 'httpService', '$location', function ($scope, $rootScope, $location, httpService, $location) {
    ...
    $scope.CarregarComerciais = function (pFiltro) {
        httpService.Post("Rotate/CarregarDados", pFiltro).then(function (response) {
            if (response.data) {
    ...
    $scope.SalvarComercial = function (pComercial) {
        httpService.Post("Rotate/SalvarComercial", pComercial).then(function (response) {
            if (response.data) {
                if (response.data[0].Status) {
    ...
    $scope.AnalisarRotate = function (pDeterminacao) {
        ...
        httpService.Post('Rotate/AnalisarRotate',pDeterminacao).then(function(response){
            if (response.data) {
                if (response.data[0].Status) {
    ...
    $scope.SalvarRotate = function (pDeterminacao) {
        httpService.Post('Rotate/SalvarDeterminacao', pDeterminacao).then(function (response) {
            if (response.data) {
