angular.module('App').controller('PropagacaoGradeMerchaController', ['$scope', '$rootScope', 'httpService', '$location', '$timeout', '$routeParams', function ($scope, $rootScope, httpService, $location, $timeout, $routeParams) {
    //================================Recebe Parametros
    ...
    $scope.SalvarPropagacaoGrade = function () {
        ...
        httpService.Post('GradeMercha/SalvarPropagacaoGrade', $scope.ParametrosPropagacao).then(function (response) {
            if (!response.data) {
