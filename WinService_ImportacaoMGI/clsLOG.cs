...
namespace WinService_ImportacaoMGI2
{
	...
	public class clsLOG
	{
		...
		protected static string GetPhysicalPath()
		{
            ...
            //string varkey = "SYSTEM" + Convert.ToChar(92) + "CurrentControlSet" + Convert.ToChar(92) + "Services" + Convert.ToChar(92) + "WinService_ImportacaoMGI2";
            ...
            //Microsoft.Win32.RegistryKey Key = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(varkey , false);
            ...
            //diretorio = "D:" + Convert.ToChar(92) + "PROJETOS" + Convert.ToChar(92) + "SBT" + Convert.ToChar(92) + "MGI" + Convert.ToChar(92) + "WinService_ImportacaoMGI";
