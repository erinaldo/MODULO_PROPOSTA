...
namespace PROPOSTA
{
    ...
    public partial class ConsultaVeiculacao
    {
        ...
        public DataTable ConsultaVeiculacaoMerchaGet(FiltroConsultaVeiculacaoModel pFiltro)
        {
            clsConexao cnn = new clsConexao(this.Credential);
            cnn.Open();
            SqlDataAdapter Adp = new SqlDataAdapter();
            ...
            try
            {
                SqlCommand cmd = cnn.Procedure(cnn.Connection, "Pr_PROPOSTA_Consulta_Veiculacao_Mercha");
                Adp.SelectCommand = cmd;
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Login", this.CurrentUser);
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Cod_Veiculo", pFiltro.Veiculo);
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Cod_Empresa", pFiltro.Empresa);
