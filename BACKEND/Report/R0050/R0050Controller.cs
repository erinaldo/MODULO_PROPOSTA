...
namespace PROPOSTA
{
    public class R0050Controller : ApiController
    {
        //=================================Lista de Report
        [Route("api/R0050/GetFilter/{Key}")]
        [HttpGet]
        ...
        //=================================Gera Report
        [Route("api/R0050/Print")]
        [HttpPost]
        [ActionName("PrintReport")]
        [Authorize()]
        public IHttpActionResult PrintReport (R0050.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0050 Cls = new R0050(User.Identity.Name);
            try
            {
        ...
        //=================================Gera Report
        [Route("api/R0050/LoadData")]
        [HttpPost]
        [ActionName("LoadData")]
        [Authorize()]
        public IHttpActionResult LoadData(R0050.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0050 Cls = new R0050(User.Identity.Name);
            try
