...
namespace PROPOSTA
{
    public class R0183Controller : ApiController
    {
        //=================================Lista de Report
        [Route("api/R0183/GetFilter/{Key}")]
        [HttpGet]
        ...
        //=================================Gera Report
        [Route("api/R0183/Print")]
        [HttpPost]
        [ActionName("PrintReport")]
        [Authorize()]
        public IHttpActionResult PrintReport (R0183.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0183 Cls = new R0183(User.Identity.Name);
            try
            {
        ...
        //=================================Gera Report
        [Route("api/R0183/LoadData")]
        [HttpPost]
        [ActionName("LoadData")]
        [Authorize()]
        public IHttpActionResult LoadData(R0183.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0183 Cls = new R0183(User.Identity.Name);
            try
