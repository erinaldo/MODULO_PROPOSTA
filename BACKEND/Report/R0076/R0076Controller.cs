...
namespace PROPOSTA
{
    public class R0076Controller : ApiController
    {
        //=================================Lista de Report
        [Route("api/R0076/GetFilter/{Key}")]
        [HttpGet]
        ...
        //=================================Gera Report
        [Route("api/R0076/Print")]
        [HttpPost]
        [ActionName("PrintReport")]
        [Authorize()]
        public IHttpActionResult PrintReport (R0076.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0076 Cls = new R0076(User.Identity.Name);
            try
            {
        ...
        //=================================Gera Report
        [Route("api/R0076/LoadData")]
        [HttpPost]
        [ActionName("LoadData")]
        [Authorize()]
        public IHttpActionResult LoadData(R0076.ReportFilterModel Filter)
        {
            SimLib clsLib = new SimLib();
            R0076 Cls = new R0076(User.Identity.Name);
            try
