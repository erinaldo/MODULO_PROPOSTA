        ...
        public ProgramaModel GetProgramaData(String pCod_Programa)
        {
            ...
            try
            {
                ...
                if (dtb.Rows.Count > 0)
                {
                    ...
                    Programa.Indica_Rejeitar_Rotativo = dtb.Rows[0]["Indica_Rejeitar_Rotativo"].ToString().ConvertToBoolean();
      ...
      //  Int32 ContadorApresentador = 0;
        ...
        public DataTable SalvarPrograma(ProgramaModel pPrograma)
        {
            ...
            try
            {
                ...
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Indica_Rejeitar_Rotativo", pPrograma.Indica_Rejeitar_Rotativo);
