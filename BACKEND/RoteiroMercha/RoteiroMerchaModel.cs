...
namespace PROPOSTA
{
    public partial class RoteiroMercha
    {
        ...
        public RoteiroMercha(String pCredential)
        {
            this.Credential = pCredential;
            this.CurrentUser = clsLib.Decriptografa(clsLib.GetJsonItem(this.Credential, "Name"));
        }
        //public class RoteiroMerchaModel
        //{
        //    public List<RoteiroMerchaProgramasModel> Programas { get; set; }
        //}
        //public class RoteiroMerchaProgramasModel
        //{
        ...
        //    public List<RoteiroMerchaItemModel> Items { get; set; }
        //}
        public class RoteiroMerchaModel
        {
            public Int32 Id_Programa { get; set; }
        ...
        public class RoteiroMerchaFiltroModel
        {
            public String Cod_Veiculo { get; set; }
            public String Data_Exibicao { get; set; }
            public String Cod_Programa { get; set; }
            public List<GuiaProgramaModel> Programas { get; set; }
        }
        public class GuiaProgramaModel
        {
            public String Cod_Programa { get; set; }
            public String Titulo_Programa { get; set; }
        ...
        public class RoteiroMerchaComercialModel
        {
            public Int32 Id_Item { get; set; }
            public String Origem{ get; set; }
            public Boolean Indica_Titulo_Programa { get; set; } 
        ...
        public class EncerramentoRoteiroMerchaModel
        {
            public String Cod_Veiculo { get; set; }
            public String Data { get; set; }
        }
